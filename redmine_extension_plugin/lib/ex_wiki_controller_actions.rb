module ExWikiControllerActions
		...
		if @page.save_with_content(@content)
			...
			respond_to do |format|
				format.html {
					...
					# edit in-place
					if params[:commit] == l(:button_save_and_continue)
						if @section
							redirect_to edit_project_wiki_page_path(@project, @page.title, :section => @section)
						else
							redirect_to edit_project_wiki_page_path(@project, @page.title)
						end
					else
